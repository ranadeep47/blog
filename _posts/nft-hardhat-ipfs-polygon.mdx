---
date: '2021-06-15'
title: Tutorial - Create a NFT contract with hardhat, IPFS, deploy to Polygon testnet and frontend to vercel
description: Create an ERC-721 NFT token using hardhat, ethers, upload resources to IPFS and deploy to polygon testnet and frontend to vercel
---

![alt text](/assets/nft/index.png "ERC-721 NFT")
...
![alt text](/assets/nft/pinata.png "Uploading to pinata")
...
![alt text](/assets/nft/deploy-local.png "Deploying contract to local node")
...
![alt text](/assets/nft/add-local-metamask.png "Adding local node to metamask")
...
![alt text](/assets/nft/deploy-matic.png "Deploying contract to matic test net") 
...
![alt text](/assets/nft/contract-verification.png "Verifying contract on polygon scan") 
...
![alt text](/assets/nft/contract-deployed.png "Verifying contract on polygon scan") 
...
![alt text](/assets/nft/add-matic-polygon.png "Add matic to metamask") 
...
![alt text](/assets/nft/deploy-vercel.png "Deploying the frontend in vercel") 
