...
After installing all the above dependencies setup your `hardhat.config.ts` by running `npx hardhat`. I'd suggest you copy hardhat and typescript configs from the code's [github repo](https://github.com/ranadeep47/erc20-hardhat-waffle-react) to get started quickly
